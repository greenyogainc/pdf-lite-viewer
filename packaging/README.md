...
1. Fill in the real `InstallerUrl` + `InstallerSha256`
   (`Get-FileHash .\PdfLiteViewer-1.0.11-win-x64.zip`).
2. Validate: `winget validate --manifest winget\manifests\g\GreenYogaInc\PDFLiteViewer\1.0.11\`
3. Submit a PR to https://github.com/microsoft/winget-pkgs under
   `manifests/g/GreenYogaInc/PDFLiteViewer/1.0.11/`.
